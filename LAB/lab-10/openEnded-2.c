...
// struct node* postfixToTree(char postfix[],int size){
//  struct node *x, *y, *z;
...
//             pushT(z);}}
//         return z;
// }// struct node*z=postfixToTree(postfix,size);
int main()
{
